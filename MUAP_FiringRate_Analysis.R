...
data {
  ...
  int<lower=1, upper=J_participant> participant[N];
  int<lower=1> J_mu;
  int<lower=1, upper=J_mu> recording_mu[N];
  int<lower=1> J_bout;
  int<lower=1, upper=J_bout> bout[N];
...
# Reference values from original Stage 2F v3:
