...
priors <- c(
  ...
  set_prior("student_t(3, 0, 1)", class = "sd", group = "id", lb = 0),
  set_prior("student_t(3, 0, 1)", class = "sigma", lb = 0),
...
intensity = "fifty" #"twenty", "fifty", "seventyFive"
